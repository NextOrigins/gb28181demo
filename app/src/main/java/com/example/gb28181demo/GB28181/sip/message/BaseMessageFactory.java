...
import com.example.gb28181demo.GB28181.sip.dialog.Dialog;
...
public abstract class BaseMessageFactory {
    ...
    public static Message createRequest(String method, SipURL request_uri,
        ...
        if (contact != null) {
			...
			if (((Objects.equals(method, "REGISTER")) || (Objects.equals(method, "INVITE"))) && (icsi != null)) {
        ...
        if ((Objects.equals(method, "INVITE")) && (icsi != null)) {
