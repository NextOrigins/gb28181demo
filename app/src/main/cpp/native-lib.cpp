...
Java_com_example_gb28181demo_GB28181_tools_PSmuxer_getHeader(JNIEnv* env,jobject ,jint len, jlong times,jint isKeyFrame){
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_gb28181demo_GB28181_tools_PSmuxer_getPESHeader(JNIEnv *env,jobject,jint stream_id,jint payloadLen,jint streaType,jlong times){
    char szTempPacketHead[256];
    memset(szTempPacketHead, 0, 256);
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_gb28181demo_GB28181_tools_PSmuxer_getRtpHeader(JNIEnv *env,jobject,jint marker_flag,jint cseq,jlong curpts,jint ssrc){
    char szTempPacketHead[256];
    memset(szTempPacketHead, 0, 256);
