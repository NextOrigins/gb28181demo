...
public:
	...
	virtual void setLiveOem(ArLiveOem oem);
	...
	virtual int32_t recvBroadcast(const char *url, void (*callback)(uint8_t *, int));
...
private:
	...
	webrtc::A_G711Encoder*		g711_encoder_;
