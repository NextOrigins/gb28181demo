...
public class ArLivePusherImpl extends ArLivePusher {
    ...
    public int startPush(String pushUrl) {
        if (TextUtils.isEmpty(pushUrl)||(!pushUrl.startsWith("webrtc://")&&!pushUrl.startsWith("rtmp://")&&!pushUrl.startsWith("rtsp://"))&&!pushUrl.startsWith("rtp://")){
    ...
    @Override
    public void recvBroadcast(String url, OnRecvBroadcast broadcast) {
        nativeInstance.nativeRecvBroadcast(nativeId, url, broadcast);
    }
