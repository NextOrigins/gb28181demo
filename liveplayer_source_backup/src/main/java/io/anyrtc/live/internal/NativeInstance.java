...
public class NativeInstance {
    ...
    protected native void setAudioDualMonoMode(long nativePtr,int mode);
    ...
    protected native int nativeReplay(long nativePtr);

    protected native int nativeSetPlayoutVolume(long nativePtr, int volume);

    protected native int nativeSeekTo(long nativePtr, int seconds);

    protected native int nativeSetSpeed(long nativePtr, float speed);
    ...
    protected native void nativeRecvBroadcast(long nativePtr, String url, OnRecvBroadcast recvBroadcast);

    public void onPcm(byte[] buffer, int size) {
